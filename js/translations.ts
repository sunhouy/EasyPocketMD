...
(function(window) {
    ...
    const translations = {
        zh: {
            ...
            diffFoldedLines: '[已折叠 {count} 行相同内容，点击展开]',
            diffNoDifferences: '无差异内容',
            ...
            lines: '行数',
            words: '词汇数(英文/数字)',
            wordCountTokens: 'Token数',
            tokenCountHelp: '基于 gpt-tokenizer (cl100k_base) 计算，反映主流大模型(如GPT-4)实际消耗的Token数，始终包含原始排版标记。',
            includeFormatting: '包含 Markdown 标记',
            includePunctuation: '包含标点符号',
            includeSpaces: '包含空格',
            includeEmptyLines: '包含空行',
            fileManagement: '文件管理',
            documentTools: '文档工具',
            editingAndHistory: '编辑与版本',
            sharingAndOutput: '分享与输出',
            others: '其他',
            cloudPrint: '云打印',
            ...
            createHistoryVersionSuccess: '历史版本已创建',
            historyVersionNoChanges: '内容无变化，未创建新历史版本',
            createHistoryVersionFailed: '创建历史版本失败',
            noActiveFileForHistory: '当前没有可创建历史版本的文件',
            ...
            switchAccount: '切换账户',
            addAccount: '添加账户',
            addAccountHint: '输入已有账户即可登录，账户不存在将自动注册新账户。',
            confirm: '确认',
            confirmSwitch: '确认切换',
            ...
            insertCodeBlockTitle: '插入代码块',
            codeLanguageLabel: '编程语言',
            codeLanguagePlaceholder: '如：javascript、python（可留空）',
            codeContentLabel: '代码内容',
            codeContentPlaceholder: '输入代码…',
            codeContentRequired: '请输入代码内容',
            codeBlockInserted: '代码块已插入',
            insertLinkTitle: '插入链接',
            linkTextLabel: '链接文字',
            linkTextPlaceholder: '链接显示文字',
            linkUrlLabel: '链接地址',
            linkUrlRequired: '请输入链接地址',
            defaultLinkText: '链接',
            linkInserted: '链接已插入',
            insertWebImageTitle: '插入网络图片',
            imageUrlLabel: '图片地址',
            ...
            outlinePreview: '大纲预览',
            pageRangeSelection: '选择导出页数范围（最多30页）',
            startPage: '起始页',
            endPage: '结束页',
            totalPages: '总页数',
            pageRangeError: '页数范围无效或超过30页限制',
            generatePages: '生成页面',
            downloadPPT: '下载PPT',
            page: '页',
            pages: '页面',
        ...
        en: {
            ...
            diffFoldedLines: '[Folded {count} identical line(s), click to expand]',
            diffNoDifferences: 'No differences',
            ...
            lines: 'Lines',
            words: 'Words (Alphanumeric)',
            wordCountTokens: 'Estimated Tokens',
            tokenCountHelp: 'Calculated using gpt-tokenizer (cl100k_base), reflecting actual tokens consumed by mainstream LLMs like GPT-4. Always includes original formatting markers.',
            includeFormatting: 'Include Markdown Formatting',
            ...
            editingAndHistory: 'Editing & History',
            sharingAndOutput: 'Sharing & Output',
            others: 'Others',
            ...
            createHistoryVersion: 'Create History Version',
            createHistoryVersionSuccess: 'History version created',
            historyVersionNoChanges: 'No content changes, no new history version created',
            createHistoryVersionFailed: 'Failed to create history version',
            noActiveFileForHistory: 'No active file available for history snapshot',
            ...
            addAccountHint: 'Enter an existing account to log in, or register a new account automatically if it does not exist.',
            confirm: 'Confirm',
            ...
            switchAccountDesc: 'Are you sure you want to switch to account {username}?',
            ...
            insertCodeBlockTitle: 'Insert Code Block',
            codeLanguageLabel: 'Language',
            codeLanguagePlaceholder: 'e.g. javascript, python (optional)',
            codeContentLabel: 'Code',
            codeContentPlaceholder: 'Enter code…',
            codeContentRequired: 'Please enter code',
            codeBlockInserted: 'Code block inserted',
            ...
            insertWebImageTitle: 'Insert Web Image',
            imageUrlLabel: 'Image URL',
            imageUrlRequired: 'Please enter image URL',
            imageAltLabel: 'Alt text',
            imageAltPlaceholder: 'Description (optional)',
            defaultImageAlt: 'Image',
            imageInserted: 'Image inserted',
            insertTableTitle: 'Insert Table',
            tableRowsLabel: 'Rows',
            tableColsLabel: 'Columns',
            tablePreviewHint: 'Preview (use ± to adjust rows/columns)',
            ...
            // Welcome document
            welcomeTitle: 'Welcome to EasyPocketMD',
            welcomeContent: 'This is a new document.',
            features: 'Features',
            featureMarkdown: 'Markdown syntax support',
            ...
            linux: 'Linux',
            macos: 'macOS',
            pleaseLoginToUse: 'Please log in before using this feature',
            ...
            indentParagraph: 'Indent first line of each paragraph',
            fitToPage: 'Fit content to one page',
            advancedHeadingSettings: 'Advanced Heading Sizes',
            ...
            h5Size: 'H5 Size (pt)',
            h6Size: 'H6 Size (pt)',
            quickSetDecrement: 'Quick decrement step (pt)',
            ...
            parsingResponseError: 'Failed to parse response',
            websocketError: 'WebSocket error',
            networkNotConnected: 'Network not connected, please connect',
            printClientConnection: 'Print Client Connection',
            cannotConnectToClient: 'Cannot connect to print client',
            pleaseEnsureClientStarted: 'Make sure the print client is running and bound with your account credentials',
            retryConnection: 'Retry Connection',
            connecting: 'Connecting...',
            connectionFailed: 'Connection failed. Make sure the print client is running and logged in with the correct credentials',
            processingUploadedFiles: 'Processing uploaded files...',
            filePrintTaskSent: 'Print task sent',
            ...
            detectingLocalNewFiles: 'Detected {count} new local file(s), uploading automatically...',
            ...
            pageRangeSelection: 'Select page range to export (max 30 pages)',
            startPage: 'Start Page',
            endPage: 'End Page',
            totalPages: 'Total Pages',
            pageRangeError: 'Invalid page range or exceeds 30 pages limit',
